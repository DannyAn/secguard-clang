...
const (
	...
	// development team: one row per actionable (confirmed/suspected) finding with
	// a source-context snippet, so confirmation can happen inside a spreadsheet
	// without opening the source tree. It is a one-way export (never read back).

...
- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/crypto.c:18`
- **Function:** `authenticate_user`
- **Variable:** `token`

## Evidence

- **hardcoded_secret:** hardcoded secret in authenticate_user at line 18

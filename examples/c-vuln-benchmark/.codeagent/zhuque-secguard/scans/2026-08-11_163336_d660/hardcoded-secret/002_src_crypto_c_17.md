...
- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/crypto.c:17`
- **Function:** `authenticate_user`
- **Variable:** `password`

## Evidence

- **hardcoded_secret:** hardcoded secret in authenticate_user at line 17

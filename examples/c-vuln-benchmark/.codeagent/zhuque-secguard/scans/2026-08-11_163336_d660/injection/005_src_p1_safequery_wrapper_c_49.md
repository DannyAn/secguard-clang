...
- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/p1_safequery_wrapper.c:49`
- **Function:** `lookup_user_unsafe`
- **Variable:** `sprintf(query, "SELECT * FROM users WHERE name = '%s'", username)`

## Evidence

- **unsafe_call:** unsafe function call in lookup_user_unsafe at line 49

# Buffer Overflow in parse_task_name

**CWE:** CWE-787

## Location

- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/parser.c:20`
- **Function:** `parse_task_name`
- **Variable:** `strcpy(task->name, input)`

## Evidence

- **buffer_access:** buffer access in function parse_task_name at line 20
- **call_path:** function parse_task_name is reachable from entry
...
Validate the buffer size before accessing `strcpy(task->name, input)` in `parse_task_name`:

...
- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/network.c:84`
- **Function:** `cleanup_packets`
- **Variable:** `packet_queue[i]`

## Evidence

- **buffer_access:** buffer access in function cleanup_packets at line 84

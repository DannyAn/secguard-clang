# Buffer Overflow in cleanup_entries

**CWE:** CWE-787

## Location

- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/allocator.c:62`
- **Function:** `cleanup_entries`
- **Variable:** `g_entries[i]`

## Evidence

- **buffer_access:** buffer access in function cleanup_entries at line 62
- **call_path:** function cleanup_entries is reachable from entry
...
Validate the buffer size before accessing `g_entries[i]` in `cleanup_entries`:

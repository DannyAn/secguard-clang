# Buffer Overflow in off_by_one_example

**CWE:** CWE-787

## Location

- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/memory_extra.c:90`
- **Function:** `off_by_one_example`
- **Variable:** `buf[i]`

## Evidence

- **buffer_access:** buffer access in function off_by_one_example at line 90
- **call_path:** function off_by_one_example is reachable from entry
...
Validate the buffer size before accessing `buf[i]` in `off_by_one_example`:

...
- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/crypto.c:49`
- **Function:** `encrypt_data_weak`
- **Variable:** `DES_set_key_unchecked(&key, &schedule)`

## Evidence

- **crypto_misuse:** weak crypto in encrypt_data_weak at line 49

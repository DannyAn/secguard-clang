# Crypto Misuse in encrypt_data_weak

**CWE:** CWE-327

## Location

- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/crypto.c:52`
- **Function:** `encrypt_data_weak`
- **Variable:** `DES_ecb_encrypt((const_DES_cblock *)plaintext,
                    (DES_cblock *)output, &schedule, DES_ENCRYPT)`

## Evidence

- **crypto_misuse:** weak crypto in encrypt_data_weak at line 52
- **call_path:** function encrypt_data_weak is reachable from entry
...
Replace the weak cryptographic primitive in `encrypt_data_weak` with a modern,

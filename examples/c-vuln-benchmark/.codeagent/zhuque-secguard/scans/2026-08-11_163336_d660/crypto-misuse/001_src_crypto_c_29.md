...
- **File:** `/Users/kongan/workbench/github/secguard-lite/examples/c-vuln-benchmark/src/crypto.c:29`
- **Function:** `generate_token_weak`
- **Variable:** `srand(time(NULL))`

## Evidence

- **crypto_misuse:** weak crypto in generate_token_weak at line 29
